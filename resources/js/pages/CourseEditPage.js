...
import {dateForHumans, preventDefault} from "../lib/helpers";
...
function CourseEditPage(props) {
    ...
    React.useEffect(async () => {
        ...
        return dispatch(appActions.clearErrors());
    }, []);
    ...
    React.useEffect(async () => {
        ...
        return dispatch(courseActions.setCourse());
    }, [courses]);
            ...
            <div className="divide-y divide-white/50 flex-1">
                <header className="sticky top-0 backdrop-blur divide-y divide-white/50">
                    ...
                    <ul className="flex-1 divide-y divide-white/50">
                        <li
                            className="@if(!isset($section)) !border-l-yellow-400 bg-blue-100/50 @else !border-l-gray-400 hover:bg-gray-100/50 @endif border-l-4 p-4 cursor-pointer transition-all"
                        >
                            <p className="">
                                General Information
                            </p>
                ...
                <ul className="flex-1 divide-y divide-white/50">
                    ...
                    {/*    className="@if(isset($section) && $section === $each) !border-l-yellow-400 bg-blue-100/50 @else !border-l-gray-400 hover:bg-gray-100/50 @endif border-l-4 p-4 px-1 cursor-pointer transition-all"*/}
                    {/*>*/}
